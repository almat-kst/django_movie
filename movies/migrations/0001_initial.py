    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acror', models.ManyToManyField(related_name='film_actor', to='movies.Actor', verbose_name='актер')),
                ('directors', models.ManyToManyField(related_name='film_direcor', to='movies.Actor', verbose_name='режиссер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.reviews', verbose_name='Родители')),
            ],
            options={
                'verbose_name': 'Отзыв',
